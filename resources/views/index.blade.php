...
<body>
    ...
    <div id="tm-wrap">
        <div class="tm-main-content">
            ...
            <!-- Carrusel y contenido adicional -->
            <div class="container">
                <div class="row">
                    <div class="col-lg-12">
                        <br>
                        <h2>Frases De Motivacion</h2>
                        <p>Cada derrota es una lección, cada victoria es un logro. ¡Sigue adelante y mejora!</p>
                    </div>
                </div>
                <div class="row">
                    <div class="col-lg-6">
                        <h3>Difruta de diferentes Juegos.</h3>
                        <img src="{{ asset('imagenes/Halo.jpeg') }}" alt="Descripción de la imagen" class="img-fluid" style="width: 500px; height: 250px; object-fit: cover;">
                    </div>
                    <div class="col-lg-6">
                        <h3>Lo mejor del dia</h3>
                        <img src="{{ asset('imagenes/Fornite.jpeg') }}" alt="Descripción de la imagen" class="img-fluid" style="width: 500px; height: 250px; object-fit: cover;">
                    </div>
                </div>
            </div>
